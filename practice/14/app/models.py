...
class Account(UserMixin, db.Model):
    ...
    review: so.Mapped[list["Review"]] = so.relationship(back_populates="account", cascade="all, delete-orphan")
    comment: so.Mapped[list["Comment"]] = so.relationship(back_populates="account", cascade="all, delete-orphan")
...
class Review(db.Model):
    ...
    comment: so.Mapped[list["Comment"]] = so.relationship(back_populates="review", cascade="all, delete-orphan")
...
class Comment(db.Model):
    ...
    review_id: so.Mapped[int] = so.mapped_column(sa.ForeignKey("review.id", ondelete="CASCADE"))
